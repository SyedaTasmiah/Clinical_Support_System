									...
									<div class="panel panel-white no-radius text-center">
										<div class="panel-body">
											...
											<p class="links cl-effect-1">
												...
												<?php 
												$users_result = mysqli_query($con,"SELECT COUNT(*) as total FROM users");
												$tblpatient_result = mysqli_query($con,"SELECT COUNT(*) as total FROM tblpatient");
												$users_count = mysqli_fetch_assoc($users_result)['total'];
												$tblpatient_count = mysqli_fetch_assoc($tblpatient_result)['total'];
												$total_patients = $users_count + $tblpatient_count;
												?>
											Total Patients: <?php echo htmlentities($total_patients); ?>		
												</a>
											</p>
										</div>
									</div>
