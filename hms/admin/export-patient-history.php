...
// Get patient information (admin has access to all patients)
$patient_query = mysqli_query($con, "SELECT * FROM users WHERE id = '$patient_id'");
$patient = mysqli_fetch_array($patient_query);

if(!$patient) {
    echo "<script>alert('Patient not found'); window.location.href='manage-users.php';</script>";
    exit();
}

// Debug: Log the access attempt
error_log("Admin export attempt - Admin ID: " . $_SESSION['id'] . ", Patient ID: $patient_id");
...
$consultations_count = mysqli_query($con, "SELECT COUNT(*) as count FROM medical_consultations WHERE patient_id='$patient_id'");
...
$doctors_count = mysqli_query($con, "SELECT COUNT(DISTINCT doctor_id) as count FROM medical_consultations WHERE patient_id='$patient_id'");
$stats['doctors'] = mysqli_fetch_array($doctors_count)['count'];
?>

<!DOCTYPE html>
<html lang="en">
<head>
    <title>Admin | Export Patient Medical History</title>
...
<body>
            ...
            <div class="main-content">
                <div class="wrap-content container" id="container">
                    ...
                    <section id="page-title">
                        <div class="row">
                            <div class="col-sm-8">
                                <h1 class="mainTitle"><i class="fa fa-download"></i> Export Patient Medical History</h1>
                            </div>
                            <ol class="breadcrumb">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="alert alert-info">
                                    ...
                                    <strong>Administrator Access:</strong> You have full access to this patient's medical records for administrative purposes.
                                    Please ensure compliance with privacy regulations and institutional policies.
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="export-card">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <p><strong>Last Updated:</strong> <?php echo date('F d, Y', strtotime($patient['updationDate'])); ?></p>
                                            <?php } ?>
                                        </div>
                                        <div class="col-md-6">
                                            <h5><i class="fa fa-bar-chart"></i> Complete Medical Data Summary</h5>
                                        ...
                                        <form id="exportForm">
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="format-option" data-format="pdf" onclick="selectFormat('pdf')">
                                                        ...
                                                        <h4>PDF Report</h4>
                                                        <p class="text-muted">
                                                            Complete medical report with professional formatting. Includes all medical data,
                                                            consultation history, and administrative information suitable for official use.
                                                        </p>
                                                        <div class="features">
                                                            <small><i class="fa fa-check text-success"></i> Complete medical history</small><br>
                                                            <small><i class="fa fa-check text-success"></i> Professional formatting</small><br>
                                                            <small><i class="fa fa-check text-success"></i> All treating doctors included</small><br>
                                                            <small><i class="fa fa-check text-success"></i> Administrative metadata</small>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="format-option" data-format="json" onclick="selectFormat('json')">
                                                        ...
                                                        <h4>JSON Data Export</h4>
                                                        <p class="text-muted">
                                                            Complete structured data export including all medical records, consultation notes,
                                                            prescriptions, and metadata. Suitable for data migration, backup, or system integration.
                                                        </p>
                                                        <div class="features">
                                                            <small><i class="fa fa-check text-success"></i> Complete data export</small><br>
                                                            <small><i class="fa fa-check text-success"></i> Machine-readable format</small><br>
                                                            <small><i class="fa fa-check text-success"></i> All relationships preserved</small><br>
                                                            <small><i class="fa fa-check text-success"></i> System integration ready</small>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="text-center" style="margin-top: 30px;">
                                                <button type="button" id="exportBtn" class="btn btn-success btn-lg" disabled onclick="exportData()">
                                                    <i class="fa fa-download"></i> Export Complete Medical History
                                                </button>
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <ul>
                                                    <li>Ensure administrative purpose justifies access</li>
                                                    <li>Document the reason for data export</li>
                                                    <li>Follow institutional data governance policies</li>
                                                    <li>Comply with HIPAA and local privacy laws</li>
                                                    <li>Maintain audit trail of data access</li>
                                                </ul>
                                            </div>
                                            <div class="col-md-6">
                                        ...
                                        <div class="alert alert-danger" style="margin-top: 15px;">
                                            <i class="fa fa-shield"></i> 
                                            <strong>Administrator Responsibility:</strong> As an administrator, you have privileged access to sensitive medical data. 
                                            Use this access responsibly and in accordance with your institution's policies and applicable laws.
                                        </div>
                                    </div>
                                </div>
                            </div>
    ...
    <script>
        ...
        function exportData() {
            ...
            // Use admin-specific export URL to avoid access issues
            var exportUrl = 'admin-export-handler.php?patient_id=' + patientId + '&format=' + format;
            ...
            setTimeout(function() {
                $('#exportBtn').html('<i class="fa fa-download"></i> Export Complete Medical History').prop('disabled', false);
            }, 2000);
        }
