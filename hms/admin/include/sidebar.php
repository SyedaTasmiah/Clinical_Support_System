				...
				<li>
								<a href="javascript:void(0)">
									<div class="item-content">
										...
										<div class="item-inner">
											<span class="title"> Patient Management </span><i class="icon-arrow"></i>
										</div>
									</div>
								</a>
								<ul class="sub-menu">
									...
									<li>
										<a href="manage-users.php">
											<span class="title"> Manage All Patients </span>
										</a>
									</li>
									
									<li>
										<a href="bulk-export-ehr.php">
											<span class="title"> Bulk Export EHR </span>
										</a>
									</li>
									
									<li>
										<a href="import-patient-data.php">
											<span class="title"> Import Patient Data </span>
										</a>
									</li>
